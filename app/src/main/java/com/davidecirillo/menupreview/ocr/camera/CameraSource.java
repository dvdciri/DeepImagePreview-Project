...
public class CameraSource {
    ...
    public void stop() {
        synchronized (mCameraLock) {
            ...
            // onDestroy the buffer to prevent oom exceptions
            ...
            if (mCamera != null) {
                ...
                try {
                    ...
                    Log.e(TAG, "Failed to onDestroy camera preview: " + e);
                }
                mCamera.release();
                mCamera = null;
            }
        ...
        public void run() {
            ...
            while (true) {
                synchronized (mLock) {
                    ...
                    // below.  We need to onDestroy mPendingFrameData to ensure that this buffer isn't
