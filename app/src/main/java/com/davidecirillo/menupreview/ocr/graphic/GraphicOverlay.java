...
public class GraphicOverlay<T extends GraphicOverlay.Graphic> extends View {
    ...
    private static float sWidthScaleFactor = 1.0f;
    private static float sHeightScaleFactor = 1.0f;
    private static int sFacing = CameraSource.CAMERA_FACING_BACK;
    ...
    public void clear() {
        synchronized (mLock) {
            Iterator<T> iterator = mGraphics.iterator();
    ...
    public float scaleX(float horizontal) {
        return horizontal * GraphicOverlay.sWidthScaleFactor;
    }
    ...
    private float scaleY(float vertical) {
        return vertical * GraphicOverlay.sHeightScaleFactor;
    }
    ...
    public static abstract class Graphic {
        ...
        public float translateX(float x){
            return mOverlay.translateX(x);
        }

        public float translateY(float y){
            return mOverlay.translateY(y);
        }
